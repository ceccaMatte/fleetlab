...
- Planned tasks:
  1. add a Prisma-backed query service for device state, recent telemetry, and notifications
  2. wire the existing device routes to the query service and add the first persisted read endpoints
