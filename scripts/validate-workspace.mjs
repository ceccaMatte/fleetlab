...
const requiredPaths = [
  ...
  "apps/api/src/modules/database/prisma-client.ts",
  "apps/api/src/modules/database/device-persistence.ts",
  "apps/api/src/modules/database/device-command-service.ts",
  "apps/api/src/modules/database/device-query-service.ts",
  "apps/api/src/modules/commands/device-command-dispatch-service.ts",
  "apps/api/src/modules/commands/command-routes.ts",
  ...
  "apps/api/test/app-services.test.ts",
  "apps/api/test/device-command-service.test.ts",
  "apps/api/test/device-command-dispatch-service.test.ts",
  "apps/api/test/command-routes.test.ts",
  "apps/api/test/device-persistence.test.ts",
  "apps/api/test/device-query-service.test.ts",
  ...
  "apps/api/test/notification-routes.test.ts",
  "apps/api/test/mqtt-broker.test.ts",
  "apps/api/test/prisma-client.test.ts",
